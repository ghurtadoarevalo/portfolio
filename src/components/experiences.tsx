...
const circle = <svg fill="none" className="w-4 h-4 text-yellow-500" viewBox="0 0 120 120" version="1.1" xmlns="http://www.w3.org/2000/svg">
					...
					<article className="grid p-6 pl-3 border-l-4 gap-5 border-white/50 font-thin sm:gap-0 sm:grid-cols-3" key={experience.time}>
						<div className='flex flex-col gap-2 pr-4'>
							<div className='flex flex-row place-items-center'>
								<span className='-ml-[22px]'>{circle}</span> <p className='ml-5 flex place-self-center font-bold text-yellow-500 text-xl'>{experience.title} </p>
							</div>
